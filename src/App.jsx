    ...
    <>
      <div className={`w-full h-full min-h-[100vh] bg-white ${darkMode && "dark"}`}>
        <div className='w-full h-full min-h-[100vh] bg-white'>
          ...
          <section id="projects" className='w-full px-0 lg:px-5 2xl:px-40 p-10 lg:py-0 dark:bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#030a1c] to-[#05174e]'>
            <Projects />
          </section>
          <div className='w-full px-0 lg:px-5 2xl:px-40 py-10 lg:py-0 dark:bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#05174e] to-[#030a1c]'>
            <Footer />
          </div>
        </div>
      </div>
